...
echo 'export { norm, foundIn, evidenciaStatus, preChecks, calcI1, calcI2, calcI3, ruleAntropometria, ruleAcoplamento2a2b, ruleProximosPontos, rulePrioridade, ruleAlergeno, coerceInstrument, coerceFatos, coerceScore, buildSheetRow, buildSchemaP, buildSchemaA, buildSystemP, buildSystemA, buildUserP, schemaToTemplate, formatoSaida, parseModelJson, blankRatio, SHEET_HEADERS, I1_ALL, I2_ALL };' >> out.js
node logic.test.mjs
rm -f out.js
